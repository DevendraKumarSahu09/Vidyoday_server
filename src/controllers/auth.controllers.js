  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "https://vidyoday-server.onrender.com/auth/google/callback",
    },
...
export const handleGoogleLoginCallback = asyncHandler(async (req, res) => {
  ...
  if (existingUser) {
    ...
    return res.redirect(`https://vidyoday-client.vercel.app/users/discover`);
  }
  ...
  return res.redirect("https://vidyoday-client.vercel.app/register");
});
